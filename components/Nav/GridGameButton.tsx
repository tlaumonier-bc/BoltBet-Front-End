...
export default function GridGameButton() {
  return (
    <button
      ...
      className="ml-2 flex cursor-not-allowed items-center gap-2 rounded-lg border border-white/10 bg-white/[0.04] px-3.5 py-1.5 text-sm font-semibold text-white/45 opacity-70"
    >
      <span>Grid Game</span>
